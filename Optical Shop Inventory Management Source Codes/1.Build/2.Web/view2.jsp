    ...
    <h2 style="color:darkslateblue;font-family: cambria;font-weight: bold; font-size: 30px;">Product Details: <%=name%></h2><br>
	            ...
	            <%
                    ...
                    <form action="cart.jsp">
                        ...
                        <tr align="center"><td>Glass Name </td><td style="color:darkblue"> <input type="text" name="gname" value="<%=rs.getString("gname")%>" readonly="" </td></tr>
                        <tr align="center"><td>Shape </td><td style="color:brown"><input type="text" name="shape" value="<%=rs.getString("shape")%>" readonly=""</td></tr>
                        <tr align="center"><td>Size </td><td style="color:crimson"><input type="text" name="size" value="<%=rs.getString("size")%>" readonly=""</td></tr>
                        <tr align="center"><td>Type </td><td style="color:forestgreen"><input type="text" name="type" value="<%=rs.getString("type")%>" readonly=""</td></tr>
                        <tr align="center"><td>Color </td><td style="color:lightseagreen"><input type="text" name="color" value="<%=rs.getString("color")%>" readonly=""</td></tr>
                        <tr align="center"><td>Cost </td><td style="color:orange"><input type="text" name="cost" value="<%=rs.getString("cost")%>" readonly=""</td></tr>
